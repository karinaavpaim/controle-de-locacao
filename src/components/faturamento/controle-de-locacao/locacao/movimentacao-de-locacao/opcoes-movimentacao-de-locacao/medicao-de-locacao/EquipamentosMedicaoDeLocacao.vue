...
export default {
  name: "EquipamentosMedicaoDeLocacao",
  ...
  props: {
    id: { type: String, required: false, default: ()=> 'equipamentos-medicao' },
    identificadorProdutoPadrao: { type: String, default: undefined },
  },
  data() {
    return {
      colunasTabelaEquipamentos: COLUNAS_TABELA_MOVIMENTACAO_LOCACAO_MEDICAO_EQUIPAMENTOS
    }
  }
}
</script>
